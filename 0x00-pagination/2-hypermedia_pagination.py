#!/usr/bin/env python3
"""
Contains a class with methods to facilitate simple pagination from CSV data.
"""
import csv
...
class Server:
    ...
    def dataset(self) -> List[List]:
        """
        Reads data from a CSV file and returns the dataset.
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> dict:
        """
        Retrieves a page of the dataset along with pagination information.
